...
package net.sf.mzmine.modules.masslistmethods.chromatogrambuilderMing;
...
public class ChromatogramBuilderMingTask extends AbstractTask {
    ...
    // User parameters
    private String suffix, massListName, filterMassString;
     ...
     * @param parameters
     */
    public ChromatogramBuilderMingTask(MZmineProject project, RawDataFile dataFile,
            ParameterSet parameters) {

        this.project = project;
        this.dataFile = dataFile;
        this.scanSelection = parameters
                .getParameter(ChromatogramBuilderMingParameters.scanSelection)
                .getValue();
        this.massListName = parameters
                .getParameter(ChromatogramBuilderMingParameters.massList)
                .getValue();

        this.mzTolerance = parameters
                .getParameter(ChromatogramBuilderMingParameters.mzTolerance)
                .getValue();
        this.minimumTimeSpan = parameters
                .getParameter(ChromatogramBuilderMingParameters.minimumTimeSpan)
                .getValue();
        this.minimumHeight = parameters
                .getParameter(ChromatogramBuilderMingParameters.minimumHeight)
                .getValue();

        this.suffix = parameters
                .getParameter(ChromatogramBuilderMingParameters.suffix).getValue();

        this.filterMassString = parameters
                .getParameter(ChromatogramBuilderMingParameters.filterMassString).getValue();

        this.filterMassPPM = parameters
                .getParameter(ChromatogramBuilderMingParameters.filterMassPPM).getValue();
    ...
    public void run() {
        ...
        for (Feature finishedPeak : chromatograms) {
            ...
            float featureMZ = (float)finishedPeak.getMZ();
