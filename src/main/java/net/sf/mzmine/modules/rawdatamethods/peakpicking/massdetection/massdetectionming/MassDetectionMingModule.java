...
public class MassDetectionMingModule implements MZmineProcessingModule {

    private static final String MODULE_NAME = "Mass detection Ming";
    ...
    public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
        return MassDetectionMingParameters.class;
    }
