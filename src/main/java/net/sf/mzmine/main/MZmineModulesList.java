...
import net.sf.mzmine.modules.masslistmethods.chromatogrambuilderMing.ChromatogramBuilderMingModule;
...
import net.sf.mzmine.modules.rawdatamethods.peakpicking.massdetection.massdetectionming.MassDetectionMingModule;
...
public class MZmineModulesList {
  ...
  public static final Class<?> MODULES[] = new Class<?>[] {
      ...
      ShoulderPeaksFilterModule.class, ChromatogramBuilderModule.class, ChromatogramBuilderMingModule.class,
